...
export function MarkdownToolbar({ textareaRef, onUpdate, theme, onUndo, onRedo, canUndo, canRedo }) {
  ...
  return (
    <div className={`flex items-center gap-1 p-2 border-b overflow-x-auto ${toolbarClass}`}>
      ...
      <ToolbarButton onClick={() => insertText('[', '](url)')} title="Enlace (Ctrl+U)" theme={theme}>
        <LinkIcon />
      </ToolbarButton>
      <ToolbarButton onClick={() => insertText('![', '](url)')} title="Imagen" theme={theme}>
        <ImageIcon />
      </ToolbarButton>
      <ToolbarButton onClick={() => insertText('![Video](', ')') } title="Video" theme={theme}>
        <VideoIcon />
      </ToolbarButton>
      <ToolbarButton onClick={() => insertText('![Audio](', ')') } title="Audio" theme={theme}>
        <AudioIcon />
      </ToolbarButton>
      <ToolbarButton 
      ...
      <ToolbarButton onClick={() => insertBlock('> **Nota:** ')} title="Nota" theme={theme}>
        <NoteIcon />
      </ToolbarButton>
    </div>
  );
